...
@Component({
  selector: 'app-search-properties-for-rent',
  templateUrl: './search-properties-for-rent.component.html',
  styleUrls: ['./search-properties-for-rent.component.css']
})
export class SearchPropertiesForRentComponent implements OnInit {
